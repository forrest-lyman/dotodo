...
let UserService = (() => {
    ...
    var UserService = _classThis = class {
        constructor() {
            ...
            this.user = (0, rxjs_interop_1.toSignal)((0, auth_1.user)(this.auth).pipe((0, rxjs_1.map)((u) => u ? {
                uid: u.uid,
        ...
        signIn() {
            return (0, auth_1.signInWithPopup)(this.auth, new auth_2.GoogleAuthProvider());
        }
        signOut() {
