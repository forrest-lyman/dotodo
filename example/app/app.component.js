...
let AppComponent = (() => {
    ...
    var AppComponent = _classThis = class {
        constructor() {
            ...
            this.bottomSheet = (0, core_1.inject)(bottom_sheet_1.MatBottomSheet);
        }
        signOut() {
        ...
        terms() {
            this.bottomSheet.open(terms_of_use_component_1.TermsOfUseComponent, {
                panelClass: 'legal'
            });
        }
        privacy() {
            this.bottomSheet.open(privacy_component_1.PrivacyComponent, {
                panelClass: 'legal'
            });
        }
    };
